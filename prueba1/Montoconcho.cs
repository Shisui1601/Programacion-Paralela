...
class Motoconchista
{
    ...
    {
        int avance = rand.Value.Next(15, 41);
        if (rand.Value.NextDouble() < 0.1) 
        {
    ...
    {
        int avance = rand.Value.Next(10, 31);
        if (rand.Value.NextDouble() < 0.05) 
        {
    ...
    static void Main()
    {
        ...
        while (!carreraTerminada)
        {
            ...
            foreach (var moto in motoconchos)
            {
                ...
                int accion = new Random().Next(1, 5);
                switch (accion)
                {
